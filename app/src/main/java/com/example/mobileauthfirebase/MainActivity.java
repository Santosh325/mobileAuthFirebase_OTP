package com.example.mobileauthfirebase;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        smsCodeVerificationField = findViewById(R.id.sms_code);
        startVerificationButton = findViewById(R.id.auth_button);
        ...
        startVerificationButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(number.isEmpty() || number.length() < 10) {
                    phoneNumberField.setError("Valid number is Requires");
